    ...
    <section className="text-center" id="education">
      ...
      <ul className="flex flex-col gap-14 mb-14">
        <li>
          ...
          <p className="text-white-darkest font-source text-sm mb-7">Completed in July 2023</p>
      ...
      <ul className="flex flex-col gap-14">
        <li className="space-y-2">
          <p className="font-source text-base text-white-dark">Name of the education</p>
